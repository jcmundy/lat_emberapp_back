...
class FlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flavor" do
    assert_difference('Flavor.count') do
      post flavors_url, params: { flavor: { gelato_id: @flavor.gelato_id, name: @flavor.name, yogurt_id: @flavor.yogurt_id } }, as: :json
    end
  ...
  test "should update flavor" do
    patch flavor_url(@flavor), params: { flavor: { gelato_id: @flavor.gelato_id, name: @flavor.name, yogurt_id: @flavor.yogurt_id } }, as: :json
    assert_response 200
  end
